...
class Avar extends Models implements IModels {
    ...
    */
    ...
    public function seleccionar(){
      ...
      $usuarios=$this->db->query_select("select * from tblpersonal where area_personal='$tipo' and estado='1' order by nombre_personal");
      if ($usuarios!=false){
      $html="
      <div class='box'>
          ...
          $html.="<div class='box-body'>
                  ...
                  <table class='table table-bordered table-responsive' style='width:100%'>
                       ...
                       <tbody>
                          ...
                          $suma_viatico='0';
                          $totaltodo='0';
                          $usuarios=$this->db->query_select("select tblpersonal.cod_personal,tblpersonal.rut_personal,tblpersonal.nombre_personal,(select cantidad_dias from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal and user_registra='$datousuario' limit 1 ) as dias, (select DISTINCT idasociada from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal and user_registra='$datousuario') as idasociada from tblpersonal inner join tbldetalleviatico_temporal on tblpersonal.cod_personal=tbldetalleviatico_temporal.id_user where user_registra='$datousuario' order by tblpersonal.nombre_personal");
                          if($usuarios==false){
                            return array("success"=>"0","message"=>"Debe seleccionar PERSONAL");
                          }
          ...
          if($value['viatico']!=false){
                  ...
                  <table class='table table-bordered table-responsive'>
                       ...
                       <tbody>
                          ...
                          $suma_x_persona='0';
                          $totaltodo='0';
                          $usuarios=$this->db->query_select("select tblpersonal.cod_personal,tblpersonal.rut_personal,tblpersonal.nombre_personal,(select cantidad_dias from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal limit 1 ) as dias, (select DISTINCT idasociada from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal limit 1 ) as idasociada from tblpersonal inner join tbldetalleviatico_temporal on tblpersonal.cod_personal=tbldetalleviatico_temporal.id_user where user_registra='$datousuario' order by tblpersonal.nombre_personal");
                          if($usuarios==false){
                            return array("success"=>"0","message"=>"Debe seleccionar PERSONAL");
                          }
                          foreach ($usuarios as $key2 => $value2) {
                      ...
                      <table class='table table-bordered table-responsive'>
                           ...
                           <tbody>
                              ...
                              $suma_x_persona='0';
                              $totaltodo='0';
                              $usuarios=$this->db->query_select("select tblpersonal.cod_personal,tblpersonal.rut_personal,tbldetalleviatico_temporal.chofer,tblpersonal.nombre_personal,(select cantidad_dias from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal ) as dias,(select idasociada from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal ) as idasociada from tblpersonal inner join tbldetalleviatico_temporal on tblpersonal.cod_personal=tbldetalleviatico_temporal.id_user where user_registra='$datousuario' order by tblpersonal.nombre_personal");
                              foreach ($usuarios as $key2 => $value2) {
                                    $gasto_viatico=$value['viatico']*$value2['dias'];
                                    $html.="<td>".$value2['rut_personal']."</td>
                                            <td>".$value2['nombre_personal']."</td>
                    ...
                    <table class='table table-bordered table-responsive' style='width:100%'>
                         ...
                         <tbody>
                            ...
                            $suma_pasaje='0';
                            $suma_x_persona='0';
                            $usuarios=$this->db->query_select("select tblpersonal.rut_personal,tblpersonal.nombre_personal from tblpersonal inner join tbldetalleviatico_temporal on tblpersonal.cod_personal=tbldetalleviatico_temporal.id_user where user_registra='$datousuario' order by tblpersonal.nombre_personal");
                            if($usuarios==false){
                              return array("success"=>"0","message"=>"Debe seleccionar PERSONAL");
                            }
                            foreach ($usuarios as $key2 => $value2) {
                        ...
                        <table class='table table-bordered table-responsive' style='width:100%'>
                             ...
                             <tbody>
                                <tr>";
                                $suma_peaje='0';
                                $usuarios=$this->db->query_select("select tblpersonal.cod_personal,tblpersonal.rut_personal,tblpersonal.nombre_personal,tbldetalleviatico_temporal.chofer,(select cantidad_dias from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal ) as dias from tblpersonal inner join tbldetalleviatico_temporal on tblpersonal.cod_personal=tbldetalleviatico_temporal.id_user where user_registra='$datousuario' order by tblpersonal.nombre_personal");
                                foreach ($usuarios as $key2 => $value2) {
                                      $html.="<td style='width:10%'>".$value2['rut_personal']."</td>
                    ...
                    $html.="
                          ...
                          <table class='table table-bordered table-responsive'>
                               ...
                               <tbody>
                                  ...
                                  $suma_x_persona='0';
                                  $totaltodo='0';
                                  $usuarios=$this->db->query_select("select tblpersonal.cod_personal,tblpersonal.nombre_personal,tblpersonal.rut_personal, tbldetalleviatico.montoviaticopp,tbldetalleviatico.chofer, tbldetallemovil.costo_movil,tbldetalleviatico.cant_dias, (select idasociada from tblcalculotemporal inner join tblpersonal tblpers2 on tblcalculotemporal.id_usuario=tblpers2.cod_personal where tblpers2.cod_personal=tblpersonal.cod_personal and idasociada!='".$value['num_proyecto']."' limit 1) as idasociada from tblpersonal inner join tbldetalleviatico on tblpersonal.cod_personal=tbldetalleviatico.id_usuarios inner join tblcontrol_proyectos on tbldetalleviatico.id_detalleproyecto=tblcontrol_proyectos.id_detalleviatico inner join tbldetallemovil on tblcontrol_proyectos.id_detalletransporte=tbldetallemovil.id_detallemovil where tblcontrol_proyectos.id_detalleviatico='".$value['num_proyecto']."' order by tblpersonal.nombre_personal");
...
//----------------------------------------------------------------------------------------------------------------------Areas
  ...
  public function guardararea(){
     ...
     $area=$this->db->query_select("select * from tblareas where cod_area='$codarea'");
     if($area==false){
