    ...
    public function login() : array {
        try {
            ...
            if ($this->authentication($email, $pass)) {
               ...
               $idusuario=$this->db->query_select("select id_user from users where email='$email'");
               $this->db->query_select("delete from tblfechatemporal where id_user='".$idusuario[0]['id_user']."'");
