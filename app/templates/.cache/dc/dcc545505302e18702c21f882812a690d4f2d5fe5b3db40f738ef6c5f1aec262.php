...
class __TwigTemplate_7862ac664e36bd9689874c3efcf3f5c94101f4d5bbf3e93ba90074428cf23a88 extends Twig_Template
{
            ...
            <div class=\"form-group\">
              <label class=\"col-sm-2 control-label\">
                {% if owner_user['foto'] == 1 %}
                  <img style=\"border:1px solid #eaeaea;border-radius:5px;\" src=\"views/app/images/avatares/{{ owner_user['name_foto'] }}\" width=\"128\">
                {% else %}
...
{% endblock %}
", "portal/perfil_usuario.twig", "C:\\xampp\\htdocs\\recursos\\app\\templates\\portal\\perfil_usuario.twig");
    }
}
