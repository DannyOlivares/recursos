...
class __TwigTemplate_026b9dbcd94350faf3f2b46b8e431f04cb878159871d6b8a44c241448b7c48b2 extends Twig_Template
{
              ...
              <div class=\"form-group\">Pagina de Inicio
                <select name='pagina_inicio' id='pagina_inicio' class='form-control'>
                  ...
                  {% for m in db_menu if false != db_menu %}
                    {% if m.url == db_users.pagin_inicio  %}
                      <option value='{{ m.url }}' selected='selected'>{{ m.url }}</option>
                    {% else %}
...
{% endblock %}
", "administracion/usuarios.twig", "C:\\xampp\\htdocs\\helpdesk\\app\\templates\\administracion\\usuarios.twig");
    }
}
